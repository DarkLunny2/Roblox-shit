...
local Window = Library.CreateLib("CumSticks.xyz Tatakai", "BloodTheme")

-- MAIN
local Credits = Window:NewTab("Credits ")
local Credits = Credits:NewSection("Credits")
Credits:NewLabel("Developer CumSticks")

local Main  = Window:NewTab("Main")
local Main = Main:NewSection("Main ")

Main:NewButton("Auto clan spinner", "AUTO CLAN SPINNER", function(v)
    print("Clicked")
...
VisualSection:NewButton("Skeleron Esp", "Skeleron Esp", function()
    ...
    game.Players.PlayerAdded:Connect(function(newplr)
        ...
        PlayerOptions:NewButton("Fly ", "Fly", function()
            print("Clicked")
        ...
        PlayerOptions:NewSlider("Walkspeed", "Changes the walkspeed", 250, 16, function(v)
            game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = v
        end)
        
        PlayerOptions:NewSlider("Jumppower", "Changes the jumppower", 250, 50, function(v)
